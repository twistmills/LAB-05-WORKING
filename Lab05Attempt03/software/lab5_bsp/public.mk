...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80011d0
SOPC_SYSID_FLAG += --sidp=0x80011d0
ELF_PATCH_FLAG  += --sidp 0x80011d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1719003579
SOPC_SYSID_FLAG += --timestamp=1719003579
ELF_PATCH_FLAG  += --timestamp 1719003579
