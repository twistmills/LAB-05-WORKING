...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../dds_and_nios_lab.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE1_SoC_QSYS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DE1_SoC_QSYS
SOPC_NAME := DE1_SoC_QSYS
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80011e0
SOPC_SYSID_FLAG += --sidp=0x80011e0
ELF_PATCH_FLAG  += --sidp 0x80011e0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1719259059
SOPC_SYSID_FLAG += --timestamp=1719259059
ELF_PATCH_FLAG  += --timestamp 1719259059
