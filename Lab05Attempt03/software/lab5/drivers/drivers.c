...
/*Esta funci�n pone en zeros entradas al FIFO, carga la muestra y genera un pulso de reloj WRCLK,
...
/*Esta funci�n pone stop en 1, detener la canci�n*/
int stop_wav() {
...
/*Esta funci�n pone stop y pause en 0*/
int play_wav() {
	IOWR(AUDIO_OUT_STOP_BASE, 0, 0);
...
/*Esta funci�n pone pause en 1, para pausar el archivo de audio*/
int pause_wav() {
	IOWR(AUDIO_OUT_PAUSE_BASE, 0, 1);
	return 0;
}
...
void select_color(unsigned char colour) {
	IOWR(COLOR_SELECTOR_BASE, 0, colour);
}
